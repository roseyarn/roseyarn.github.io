    ...
    var headerSticky = function() {
        $(window).on('scroll', function() {
            if ($(window).scrollTop() > 1) {
                $('.main-navigation').addClass('ry-transparent');
                $('.navbar').addClass('ry-transparent');

            } else {
                $('.main-navigation').removeClass('ry-transparent');
                $('.navbar').removeClass('ry-transparent');
            }
        });
    };
	headerSticky();
 ...
 */
var myApp = angular.module('roseyarn', [
    'ui.router', 'ui.bootstrap', 'uiGmapgoogle-maps'
]);
...
myApp.config(['$stateProvider',
    function ($stateProvider) {
        ...
        var homeState = {
            name: 'home',
            url: '',
            templateUrl: '/templates/ry.home.tpl.html',
            controller: 'ry.home.ctrl'
        };

        var galleryState = {
            name: 'gallery',
            url: '/gallery',
            templateUrl: '/templates/ry.gallery.tpl.html',
            controller: 'ry.gallery.ctrl'
        };

        var aboutState = {
            name: 'about',
            url: '/about',
            templateUrl: '/templates/ry.about.tpl.html'
        };

        var contactState = {
            name: 'contact',
            url: '/contact',
            templateUrl: '/templates/ry.contact.tpl.html',
            controller: 'ry.contact.ctrl'
        };

        var faqState = {
            name: 'faq',
            url: '/faq',
            templateUrl: '/templates/ry.faq.tpl.html'
        };

        var elementsState = {
            name: 'elements',
            url: '/elements',
            templateUrl: '/templates/ry.elements.tpl.html'
        };

        var loginState = {
            name: 'login',
            url: '/login',
            templateUrl: 'templates/ry.login.tpl.html'
        };

        var accountState = {
            name: 'account',
            url: '/account',
            templateUrl: 'templates/ry.account.tpl.html'
        };

        var checkoutState = {
            name: 'checkout',
            url: '/checkout',
            templateUrl: 'templates/ry.checkout.tpl.html'
        };

        var shoppingCartState = {
            name: 'shopping-cart',
            url: '/shopping-cart',
            templateUrl: '/templates/ry.shoppingcart.tpl.html'
        };

        var shopState = {
            name: 'shop',
            url: '/shop',
            templateUrl: '/templates/ry.shop.fw.sl.tpl.html',
            controller: 'ry.shop.ctrl'
        };

        var shopSingleState = {
            name: 'detail',
            url: '/detail',
            templateUrl: '/templates/ry.shop.single.tpl.html'
        };
...
(function (angular) {
    ...
    angular.module('roseyarn').controller('ry.nav.main.ctrl', [
        '$scope', '$state',
        function ($scope, $state) {

            $scope.template = '/templates/ry.nav.main.tpl.html';
...
/**
 * Created by MyPC on 2017-07-12.
 */
(function (angular) {
    'use strict';

    angular.module('roseyarn').controller('ry.home.ctrl', [
        '$scope', '$state',
        function ($scope, $state) {
            setTimeout(function () {
                initHeroSlider();
...
(function (angular) {
    ...
    angular.module('roseyarn').controller('ry.contact.ctrl', [
        '$scope', '$state',
        function ($scope, $state) {
...
(function (angular) {
    ...
    angular.module('roseyarn').controller('ry.gallery.ctrl', [
        '$scope', '$state',
        function ($scope, $state) {
            $scope.methods = {
            ...
            var initGallery = function () {
                var img = new Image();
                img.src='images/gallery/empty.svg';
                img.onload = function(){
                    setTimeout(function () {
                        initGalleryIsotopo();
                    }, 100);
    ...
    var initGalleryIsotopo = function () {
        // Isotope Grid
...
/**
 * Created by MyPC on 2017-07-17.
 */
(function (angular) {
    'use strict';

    angular.module('roseyarn').controller('ry.shop.ctrl', [
        '$scope', '$state',
        function ($scope, $state) {
